...
export var hello = function (name) { return "Hello, " + name + "!"; };
import { Component, Inject, } from "@angular/core";
import { MAT_DIALOG_DATA, MatDialog, } from "@angular/material/dialog";
import { SignaturepadComponent } from "./signaturepad/signaturepad.component";
var YourComponent = /** @class */ (function () {
    function YourComponent(dialog) {
        this.dialog = dialog;
        this.signaturePadComponent = new SignaturepadComponent();
    }
    YourComponent.prototype.openPopup = function () {
        if (!this.dialog) {
